...
#define kYLImageCacheSize 10 * 1024 * 1024
#define kYLImageCacheLength 30
...
- (void)cacheImage:(UIImage *)image forKey:(NSString *)aKey {
    ...
    if (!isFullCache){
        ...
        while (isFullCache) {
            UIImage *imageLeastRecentlyUsed = [_cachedImage objectForKey:[_priorityQueue firstObject]];
            
            _currentSize -= CGImageGetBytesPerRow(imageLeastRecentlyUsed.CGImage) * CGImageGetHeight(imageLeastRecentlyUsed.CGImage);
