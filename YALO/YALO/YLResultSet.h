...
// */
//
//@interface YLStatement : NSObject {
//    void *_statement;
//    NSString *_query;
//    long _useCount;
//    BOOL _inUse;
...
//
//
//@interface YLResultSet : NSObject {
//    YLSQLite          *_parentDB;
//    YLStatement         *_statement;
//    
//    NSString            *_query;
...
//
//@property (atomic, retain) YLStatement *statement;
//
/////------------------------------------
...
// */
//
//+ (instancetype)resultSetWithStatement:(YLStatement *)statement usingParentDatabase:(YLSQLite *)aDB;
//
///** Close result set */
//
//- (void)close;
//
//- (void)setParentDB:(YLSQLite *)newDb;
//
/////---------------------------------------
